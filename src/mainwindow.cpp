...
#define ID_MODEL_COMBO 1002
#define ID_CONFIDENCE_EDIT 1003
#define ID_IOU_EDIT 1004
#define ID_RESULTS_EDIT 1005
#define ID_STATUS_STATIC 1006
#define ID_PROGRESS_BAR 1007
#define ID_IMAGE_STATIC 1008
...
bool MainWindow::Create()
{
    ...
    m_hwnd = CreateWindowEx(
        0,
        CLASS_NAME,
        L"YOLO Object Detection - Windows Native",
        WS_OVERLAPPEDWINDOW,
...
void MainWindow::OnOpenImage()
{
    ...
    if (GetOpenFileName(&ofn)) {
        ...
        SetWindowText(m_hStatusStatic, L"Processing...");
        m_isProcessing = true;
        ...
        // Start detection in a separate thread (simplified for this example)
...
void MainWindow::ResizeControls()
{
    ...
    SetWindowPos(m_hImageStatic, NULL, 200, 10, width - 220, height - 320, SWP_NOZORDER);
    
    // Resize progress bar
    SetWindowPos(m_hProgressBar, NULL, 200, height - 300, width - 220, 20, SWP_NOZORDER);
    
    // Resize status label
    SetWindowPos(m_hStatusStatic, NULL, 200, height - 270, width - 220, 20, SWP_NOZORDER);
    
    // Resize results text area
    SetWindowPos(m_hResultsEdit, NULL, 200, height - 240, width - 220, 200, SWP_NOZORDER);
}